    ...
    angular.module('treeGrid', []).directive('treeGrid', ['$timeout',
        function ($timeout) {
            return {
              ...
              <table class=\"table tree-grid table-condensed table-striped table-small\">\
                  <thead>\
                  <tr>\
                      <th colspan=\"{{colDefinitions.length + 1}}\">Portfolio Summary (* Calculated value for indicitive purposes.)</th>\
                  </tr>\
                  <tr>\
                  ...
                  <tr ng-repeat=\"row in tree_rows | filter:{visible:true} track by row.branch.uid\"\
                      ...
                      <td style=\"width: 35px\"><a ng-click=\"user_clicks_branch(row.branch)\"><i ng-class=\"row.tree_icon\"\
