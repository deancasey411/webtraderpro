...
app.config(['$routeProvider','ntConfig',
    function ($routeProvider, ntConfig) {
        ...
        var dashboardTemplateUrl = "app/pages/dashboard.html";
        if (ntConfig.hideJSEEquityData) {
            dashboardTemplateUrl = "app/pages/dashboardNonEquities.html";
        }
