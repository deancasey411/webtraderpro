...
<head>
    ...
    <title>Nutcracker - WebTraderPro</title>
...
<body class="body">
    <div id="divPrivateBrowsing" style="display: none">
        <div class="navbar navbar-default">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#/home">WebTraderPro</a>
            </div>
        ...
        <div class="footer">
            <a href="http://www.lightstreamer.com" class="pull-left" target="_blank"><img style="display: block; max-width: 90px; max-height: 95px; width: auto; height: auto;"
                 src="images/ls_logo_light.png"></a>
            <span>Copyright <%= DateTime.Now.Year %> by <a href="http://www.nutcracker.africa" target="_blank">Nutcracker Technologies Kenya Limited</a> - v<%= GetVersion() %></span>
        </div>
    </div>
            ...
            <div id="menu" class="navbar navbar-default">
                ...
                <div class="navbar-collapse collapse" data-collapse="!navbarExpanded">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li data-ng-show="authentication.isAuth" data-ng-class="{'active':isActive('/help')}"><a href="docs/WTPv2_Help_AnalyticsPortal.pdf" target="_blank"><span class="glyphicon glyphicon-question-sign"></span>&nbsp;Help</a></li>
    ...
    <%: System.Web.Optimization.Scripts.Render("~/js/app-analytics") %>
